...
public class RepositoryGenerator implements IGenerator {
    ...
    public String getTemplatePath() {
        return "template/repository.tpl";
    }
    ...
    public void generate(Table table, GlobalConfig globalConfig) {
        ...
        String entityPackagePath = (packageConfig.getBasePackage() + ".repository").replace(".", "/");
        File entityJavaFile = new File(packageConfig.getSourceDir(),
            entityPackagePath + "/" + table.buildEntityClassName() + "Repository" + ".java");
