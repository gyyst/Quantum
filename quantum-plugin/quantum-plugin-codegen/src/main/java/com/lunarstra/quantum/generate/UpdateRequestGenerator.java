...
public class UpdateRequestGenerator implements IGenerator {

    @Override
    public String getTemplatePath() {
        return "template/updateRequest.tpl";
    }
    ...
    public void generate(Table table, GlobalConfig globalConfig) {
        ...
        File entityJavaFile = new File(packageConfig.getSourceDir(),
            entityPackagePath + "/" + "Update" + table.buildEntityClassName() + "Request" + ".java");
